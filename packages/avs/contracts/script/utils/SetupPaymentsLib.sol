...
library SetupPaymentsLib {
    ...
    function createAVSRewardsSubmissions(
        ...
        ECDSAServiceManagerBase(neuralFiServiceManager).createAVSRewardsSubmission(rewardsSubmissions);
    }
    ...
    function createOperatorDirectedAVSRewardsSubmissions(
        ...
        ECDSAServiceManagerBase(neuralFiServiceManager).createOperatorDirectedAVSRewardsSubmission(rewardsSubmissions);
    }
